...
interface IEvent<VT = any> {
    ...
    transform?:
        | { corner: string; original: Object; originX: string; originY: string; width: number }
        | undefined;
    selected?: Object[];
    value: VT;
}
...
interface IAllFilters {
    ...
    HueRotation: {
         ...
         * @param [options] Options object
         */
        new (options?: { rotation?: number | undefined }): IContrastFilter;
        /**
         * Returns filter instance from an object representation
         * @param object Object to create an instance from
         */
    ...
    RemoveColor: {
        new (options?: { distance?: number; color?: string; [key: string]: any }): ISepiaFilter;
        fromObject(object: any): ISepiaFilter;
    };
    Gamma: {
        new (options?: { gamma?: number[]; [key: string]: any }): ISepiaFilter;
        fromObject(object: any): ISepiaFilter;
    };
}
...
export type Resources = Record<string, HTMLCanvasElement>;
