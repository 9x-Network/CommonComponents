...
fabric.Canvas.prototype._historyNext = function () {
    ...
    return JSON.stringify({
        ...json,
        objects: json.objects.filter((item) => item.customType !== 'cursor'),
    });
};
...
fabric.Canvas.prototype._historyEvents = function () {
    return {
        ...
        'object:skewed': this._historySaveAction,
        'erasing:end': this._historySaveAction,
        'bg:changed': this._historySaveAction,
        'object:filled': this._historySaveAction,
    };
};
...
fabric.Canvas.prototype._historyInit = function () {
    this.historyUndo = [];
    this.historyRedo = [];
    this.extraProps = ['selectable', 'name'];
 ...
 */
fabric.Canvas.prototype._historySaveAction = function (evt) {
    if (this.historyProcessing || evt?.target?.customType === 'cursor') return;
